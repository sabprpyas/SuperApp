 ...
 */
public abstract class RecycleAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    //viewItem的点击事件监听
    ...
    public RecycleAdapter(int layoutId) {
        this.layoutId = layoutId;
    }

    public RecycleAdapter(int layoutId, int layoutFootViewId) {
        this.layoutId = layoutId;
