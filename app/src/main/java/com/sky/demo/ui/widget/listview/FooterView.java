...
//    private ImageView mHintImage;
    ...
    private void initView(Context context) {
        mLayout = LayoutInflater.from(context).inflate(R.layout.list_footer, null);
        mLayout.setLayoutParams(new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT,
...
//                    mHintImage.startAnimation(mRotateUpAnim);
    ...
    /**
     * Set list_footer view bottom margin.
     *
     * @param margin
     */
    ...
    /**
     * Get list_footer view bottom margin.
     *
     * @return
     */
    ...
    /**
     * hide list_footer when disable pull load more
     */
    public void hide() {
        LayoutParams lp = (LayoutParams) mLayout.getLayoutParams();
        lp.height = 0;
